...
CONFIG_INPUT_PINS = [
    mc.pin.GPIO16, # Pinky finger
    mc.pin.GPIO18, # Ring finger
    mc.pin.GPIO26, # Middle finger
    mc.pin.GPIO28, # Index finger
    mc.pin.GPIO10, # Leftmost thumb
    mc.pin.GPIO6, # Middle thumb
    mc.pin.GPIO3, # Rightmost thumb
]
...
CHORD_TABLE = {
    ...
    (True, True, False, False, False, False, False): "c",
    (False, False, True, False, False, False, False): "d",
    (True, False, True, False, False, False, False): "e",
